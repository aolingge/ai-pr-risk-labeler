...
function usage() {
  console.log(`ai-pr-risk-labeler v${VERSION}

Usage:
  ai-pr-risk-labeler --path FILE_OR_DIR
  ai-pr-risk-labeler FILE_OR_DIR --markdown
  ai-pr-risk-labeler FILE_OR_DIR --sarif > results.sarif
  ai-pr-risk-labeler FILE_OR_DIR --annotations
  ai-pr-risk-labeler FILE_OR_DIR --redact
...
try {
  ...
  console.error(`ai-pr-risk-labeler: ${error.message}`);
  process.exit(2);
}
